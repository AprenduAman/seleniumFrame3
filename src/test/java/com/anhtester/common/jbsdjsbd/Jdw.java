...
public class Jdwbwjdbjw {

    private WebDriver driver;
    private String className = "Jdwbwjdbjw";
    private String subid = "JB-105";

    // Constructor to initialize WebDriver and set className and subid
    public Jdwbwjdbjw(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        Jdwbwjdbjw test = new Jdwbwjdbjw(driver);
        test.runTest();
    }
}
