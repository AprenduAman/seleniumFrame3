...
public class Bjebjebj {

    private WebDriver driver;
    private String className = "Bjebjebj";
    private String subid = "JB-108";

    // Constructor to initialize WebDriver and set className and subid
    public Bjebjebj(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        Bjebjebj test = new Bjebjebj(driver);
    //editedpart1    test.runTest();
    }
}